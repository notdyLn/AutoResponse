        ...
        try {
            ...
            const leaderboardFields = topEntries.map((entry, index) => {
                ...
                const groups = entry.groups
                    ? entry.groups.split(",").map((group) => group.trim())
                    : [];
                ...
                const prevwinner = groups.includes("Season 1 Winner")
                    ? RANKS.s1
                    : "";
            ...
            if (season === "current") {
                description =
                    "This is the current leaderboard. The next season starts <t:1735707600:R>";
            } else {
